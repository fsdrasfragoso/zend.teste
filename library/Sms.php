<?php
include '../public/rotinas_processamento/conn/config.php';
include '../public/rotinas_processamento/conn/conecta.php';


class Sms extends Zend_Controller_Action{
	...
	public function EnviaSms($params, $type = false) {
        ...
        public function LogSMS($remetente, $destinatario, $identificador, $tipo, $pedido, $mensagem, $errorCode, $msg)
        {
            ...
            $resultado = mysqli_query($conecta, $sql) or die ("Error in query: $sql. ".mysqli_error());
